...
def turtle4():
    ...
    bobby.speed = 12
    bobby.pen = rg.Pen('green',15)
    bobby.draw_square(50)


def turtle5():
    steve = rg.SimpleTurtle('classic')
    steve.speed = 15
    steve.pen = rg.Pen('purple',20)
    steve.draw_circle(100)

    ninja = rg.SimpleTurtle('turtle')
    ninja.speed = 4
    ninja.pen = rg.Pen('blue', 25)
    ninja.draw_regular_polygon(6,20)
